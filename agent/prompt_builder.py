...
KANBAN_GUIDANCE = (
    ...
    "eyes on it.\n"
    "6. **Respect role limits.** No scheduling authority? Comment + "
    "block(kind='needs_input'). Otherwise kanban_create(parents=[your-task-id]) "
    "creates a successor. Dependency waits require an unfinished parent, "
    "never a child. Never complete failed work.\n"
    "\n"
    "## Orchestrator mode\n"
    "\n"
