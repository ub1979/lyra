...
const PROVIDER_DISPLAY: Record<string, { order: number; title: string }> = {
  ...
  // Both Anthropic entries sit at the bottom: the direct API path first, then
  // the isolated local Claude Code subscription path.
  anthropic: { order: 5, title: 'Anthropic API Key' },
  'claude-cli': { order: 6, title: 'Claude Code CLI (subscription)' }
}
