...
export const en: Translations = {
  ...
  boot: {
    ready: 'Idrak IT is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Idrak IT settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Idrak IT…'
    },
    errors: {
      backgroundExited: 'Idrak IT background process exited.',
      backgroundExitedDuringStartup: 'Idrak IT background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Idrak IT backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Idrak IT',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Idrak IT.',
    ...
    native: {
      ...
      inputBody: 'Idrak IT is waiting for your response.',
      turnDoneTitle: 'Idrak IT finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Idrak IT defaults?',
    ...
    plugins: {
      ...
      blurb:
        'UI extensions loaded into this app — bundled with the build, or dropped into the desktop-plugins folder (including ones Idrak IT writes). Disabling unloads a plugin live and survives restarts.',
      count: n => `${n} installed`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Idrak IT is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Idrak IT asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Idrak IT was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Idrak IT follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Idrak IT is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Idrak IT, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Idrak IT checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Idrak IT configuration...',
    ...
    gateway: {
      ...
      intro:
        'Idrak IT starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Idrak IT backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private Idrak IT backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Idrak IT backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Idrak IT Cloud',
      cloudDesc: 'Sign in once to Idrak IT Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Idrak IT Cloud',
      cloudSignIn: 'Sign in to Idrak IT Cloud',
      cloudSignedIn: 'Signed in to Idrak IT Cloud',
      cloudNeedsSignIn: 'Sign in to Idrak IT Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Idrak IT Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Idrak IT Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Idrak IT Cloud',
      cloudSignedOutMessage: 'Cleared the Idrak IT Cloud session.',
      ...
      restartingMessage: 'Idrak IT will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Idrak IT ${version}` : ''}`,
      ...
      sshDesc:
        'Idrak IT is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'Idrak IT path (optional)',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Idrak IT found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Idrak IT runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Idrak IT is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.idrakit.com/install.sh | sh) or set the Idrak IT path.',
      sshErrPlatform:
        'Unsupported remote platform. Idrak IT SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Idrak IT on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Idrak IT runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Idrak IT at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  starmap: {
    ...
    emptyDesc: 'As Idrak IT builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Idrak IT to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Idrak IT to generate pets.',
      backgroundHint: 'You can close this — Idrak IT will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Idrak IT desktop' },
    ...
    hermesActiveSessions: (version, count) => `Idrak IT ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Idrak IT environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Idrak IT will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Idrak IT backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Idrak IT. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Idrak IT...',
    placeholderReconnecting: 'Reconnecting to Idrak IT…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Idrak IT a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'Idrak IT will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Idrak IT to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Idrak IT…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Idrak IT…',
    ...
    unsupportedMessage: 'This version of Idrak IT can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Idrak IT is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Idrak IT backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Idrak IT from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Idrak IT will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Idrak IT desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Idrak IT updater takes over in its own window and reopens Idrak IT automatically when it’s done. Please don’t reopen Idrak IT yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Idrak IT reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Idrak IT reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Idrak IT needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Idrak IT',
    setupChoiceDesc:
      'Connect this app to a Idrak IT gateway you already run, or install Idrak IT locally on this computer.',
    connectExistingTitle: 'Connect to existing Idrak IT',
    ...
    installLocalTitle: 'Install Idrak IT locally',
    installLocalDesc: 'Download Idrak IT, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Idrak IT and try again.',
    remoteSetupTitle: 'Connect to existing Idrak IT',
    remoteSetupDesc: 'Enter your gateway URL. Idrak IT will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Idrak IT gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/hermes',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Idrak IT gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Idrak IT',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Idrak IT CLI or desktop instance is running. Stop any running Idrak IT instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Idrak IT installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Idrak IT",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Idrak IT is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Idrak IT…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Idrak IT',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Idrak IT at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Idrak IT connects automatically',
    ...
    authorizeThere: 'Authorize Idrak IT there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Idrak IT there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      connectionCloudTooltip: host => `Connected to Idrak IT Cloud at ${host} · click to manage`,
      ...
      gatewayTitle: 'Idrak IT inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Idrak IT will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Idrak IT is restarting...',
      askRestart: 'Ask Idrak IT to restart the server',
      lookingRestart: taskId => `Idrak IT is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Idrak IT is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Idrak IT finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Idrak IT could not restart the server.',
      stillWorking:
        'Idrak IT is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Idrak IT is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Idrak IT gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Idrak IT won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Idrak IT needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Idrak IT needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Idrak IT to use Save Image.',
    restartToSaveImages: 'Restart Idrak IT to save images',
