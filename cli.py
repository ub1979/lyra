            ...
            if quiet:
                ...
                if cli._ensure_runtime_credentials():
                    ...
                    if cli._init_agent(
                        ...
                        # session's cumulative usage (after any goal loop) on
                        # the task for Studio; a failed write must never fail
                        # the worker.
                        if os.environ.get("HERMES_KANBAN_TASK"):
                            try:
                                ...
                                record_worker_run_usage_from_env(usage_from_agent(cli.agent))
