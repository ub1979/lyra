      ...
      try {
        ...
        const prompt = "IDRAK_INTERNAL_SETUP_BEGIN " + JSON.stringify({
          ...
          delivery_rule: buildProfile === "personal"
            ? "This is the MVP fast path. Keep artifacts and research proportional to the requested app. After requirements approval, prepare a quick visual preview in .sdlc/preview/. Before asking for approval call project_run action=preview, with preview_options mapping alternative design names to their project-relative files. Ask exactly the returned question and choices through clarify; never collect an informal preview approval first. Wait for the user's answer before Development. Then move to development, smoke QA and concise run documentation; pass build_profile to every phase including Documentation. Do not invent disabled architecture or task-planning phases."
      ...
      return h("div", { className: "ub-page ub-page-home ub-theme-" + studioTheme + " ub-text-" + studioTextSize },
        h("header", { className: "ub-studio-nav" },
          ...
          h("div", { className: "ub-studio-nav-actions" },
            ...
            h("span", { className: "ub-version" }, "v0.19.64 beta"),
            textSizeControl(),
            themeToggle(),
            h("button", {
