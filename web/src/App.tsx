...
export default function App() {
  ...
  return (
    ...
    <div
      ...
      data-studio-text-size={isSimpleExperience ? studioTextSize : undefined}
      className={cn(
  ...
  return (
    ...
    <ConfirmDialog
      ...
      description={
        ...
        "This restarts the Lyra gateway process. Connected channels and active sessions will reconnect afterward."
      }
