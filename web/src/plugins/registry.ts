 ...
 *
 * Plugins call window.__IDRAK_IT_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__IDRAK_IT_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__IDRAK_IT_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__IDRAK_IT_PLUGIN_SDK__ = {
    ...
    // window.__IDRAK_IT_SESSION_TOKEN__ directly.
    authedFetch,
