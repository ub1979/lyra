 ...
 * ====================================================
 *
 * This is the public type surface for ``window.__IDRAK_IT_PLUGIN_SDK__`` and
 * ``window.__IDRAK_IT_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__IDRAK_IT_PLUGIN_SDK__`` because:
 ...
 * of calling ``fetch`` with a hand-read ``window.__IDRAK_IT_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__IDRAK_IT_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__IDRAK_IT_PLUGIN_SDK__)
// ---------------------------------------------------------------------------
...
declare global {
  interface Window {
    __IDRAK_IT_PLUGIN_SDK__?: HermesPluginSDK;
    __IDRAK_IT_PLUGINS__?: PluginRegistry;
  }
}
